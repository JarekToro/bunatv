...
export function contentItemMetadata_MediaTypeFromJSON(object: any): ContentItemMetadata_MediaType {
  switch (object) {
    case 0:
...
export function contentItemMetadata_MediaTypeToJSON(object: ContentItemMetadata_MediaType): string {
  switch (object) {
...
export const AudioRouteType: MessageFns<AudioRouteType> = {
  encode(message: AudioRouteType, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  create<I extends Exact<DeepPartial<AudioRouteType>, I>>(base?: I): AudioRouteType {
    return AudioRouteType.fromPartial(base ?? ({} as any))
  },
  fromPartial<I extends Exact<DeepPartial<AudioRouteType>, I>>(_: I): AudioRouteType {
    const message = createBaseAudioRouteType()
    return message
  },
}
...
function createBaseAudioRoute(): AudioRoute {
  return { type: undefined, name: '', supportsSpatialization: false, _unknownFields: {} }
}

export const AudioRoute: MessageFns<AudioRoute> = {
  encode(message: AudioRoute, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.supportsSpatialization !== undefined && message.supportsSpatialization !== false) {
  ...
  fromJSON(object: any): AudioRoute {
    return {
      type: isSet(object.type) ? AudioRouteType.fromJSON(object.type) : undefined,
  ...
  fromPartial<I extends Exact<DeepPartial<AudioRoute>, I>>(object: I): AudioRoute {
    const message = createBaseAudioRoute()
    message.type =
...
export const AudioTier: MessageFns<AudioTier> = {
  encode(message: AudioTier, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message._unknownFields !== undefined) {
      for (const [key, values] of globalThis.Object.entries(message._unknownFields)) {
        const tag = parseInt(key, 10)
        for (const value of values) {
...
export const SongTraits: MessageFns<SongTraits> = {
  encode(message: SongTraits, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message._unknownFields !== undefined) {
      for (const [key, values] of globalThis.Object.entries(message._unknownFields)) {
        const tag = parseInt(key, 10)
        for (const value of values) {
...
export const AlbumTraits: MessageFns<AlbumTraits> = {
  encode(message: AlbumTraits, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message._unknownFields !== undefined) {
      for (const [key, values] of globalThis.Object.entries(message._unknownFields)) {
        const tag = parseInt(key, 10)
        for (const value of values) {
...
export const PlaylistTraits: MessageFns<PlaylistTraits> = {
  encode(message: PlaylistTraits, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message._unknownFields !== undefined) {
      for (const [key, values] of globalThis.Object.entries(message._unknownFields)) {
        const tag = parseInt(key, 10)
        for (const value of values) {
  ...
  create<I extends Exact<DeepPartial<PlaylistTraits>, I>>(base?: I): PlaylistTraits {
    return PlaylistTraits.fromPartial(base ?? ({} as any))
  },
  fromPartial<I extends Exact<DeepPartial<PlaylistTraits>, I>>(_: I): PlaylistTraits {
    const message = createBasePlaylistTraits()
    return message
  },
}
...
export const ActiveFormatJustification: MessageFns<ActiveFormatJustification> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ActiveFormatJustification {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input)
    const end = length === undefined ? reader.len : reader.pos + length
...
export const FormatTier: MessageFns<FormatTier> = {
  encode(message: FormatTier, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message._unknownFields !== undefined) {
      for (const [key, values] of globalThis.Object.entries(message._unknownFields)) {
        const tag = parseInt(key, 10)
        for (const value of values) {
...
export const AudioFormat: MessageFns<AudioFormat> = {
  encode(message: AudioFormat, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.stableVariantID !== undefined && message.stableVariantID !== '') {
  ...
  fromJSON(object: any): AudioFormat {
    return {
      ...
      spatialized: isSet(object.spatialized) ? globalThis.Boolean(object.spatialized) : false,
      multiChannel: isSet(object.multiChannel) ? globalThis.Boolean(object.multiChannel) : false,
      channelLayout: isSet(object.channelLayout) ? globalThis.Number(object.channelLayout) : 0,
  ...
  fromPartial<I extends Exact<DeepPartial<AudioFormat>, I>>(object: I): AudioFormat {
    ...
    message.audioChannelLayoutDescription = object.audioChannelLayoutDescription ?? ''
...
export const ContentItemMetadata: MessageFns<ContentItemMetadata> = {
  encode(message: ContentItemMetadata, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.playbackProgress !== undefined && message.playbackProgress !== 0) {
    ...
    if (message.trackArtistName !== undefined && message.trackArtistName !== '') {
      writer.uint32(58).string(message.trackArtistName)
    }
    if (message.albumArtistName !== undefined && message.albumArtistName !== '') {
    ...
    if (message.localizedContentRating !== undefined && message.localizedContentRating !== '') {
      writer.uint32(122).string(message.localizedContentRating)
    }
    if (message.isExplicitItem !== undefined && message.isExplicitItem !== false) {
    ...
    if (message.radioStationType !== undefined && message.radioStationType !== 0) {
      writer.uint32(144).int32(message.radioStationType)
    }
    if (message.artworkAvailable !== undefined && message.artworkAvailable !== false) {
      writer.uint32(152).bool(message.artworkAvailable)
    }
    if (message.infoAvailable !== undefined && message.infoAvailable !== false) {
    ...
    if (message.numberOfSections !== undefined && message.numberOfSections !== 0) {
      writer.uint32(184).int32(message.numberOfSections)
    }
    if (message.lyricsAvailable !== undefined && message.lyricsAvailable !== false) {
      writer.uint32(192).bool(message.lyricsAvailable)
    }
    if (message.editingStyleFlags !== undefined && message.editingStyleFlags !== 0) {
      writer.uint32(200).int32(message.editingStyleFlags)
    }
    if (message.isStreamingContent !== undefined && message.isStreamingContent !== false) {
      writer.uint32(208).bool(message.isStreamingContent)
    }
    if (message.isCurrentlyPlaying !== undefined && message.isCurrentlyPlaying !== false) {
      writer.uint32(216).bool(message.isCurrentlyPlaying)
    }
    if (message.collectionIdentifier !== undefined && message.collectionIdentifier !== '') {
      writer.uint32(226).string(message.collectionIdentifier)
    }
    if (message.profileIdentifier !== undefined && message.profileIdentifier !== '') {
    ...
    if (message.artworkMIMEType !== undefined && message.artworkMIMEType !== '') {
    ...
    if (message.totalTrackCount !== undefined && message.totalTrackCount !== 0) {
    ...
    if (message.contentIdentifier !== undefined && message.contentIdentifier !== '') {
    ...
    if (message.radioStationIdentifier !== undefined && message.radioStationIdentifier !== 0) {
      writer.uint32(400).int64(message.radioStationIdentifier)
    }
    if (message.radioStationName !== undefined && message.radioStationName !== '') {
      writer.uint32(418).string(message.radioStationName)
    }
    if (message.radioStationString !== undefined && message.radioStationString !== '') {
      writer.uint32(426).string(message.radioStationString)
    }
    if (message.iTunesStoreIdentifier !== undefined && message.iTunesStoreIdentifier !== 0) {
    ...
    if (message.purchaseInfoData !== undefined && message.purchaseInfoData.length !== 0) {
      writer.uint32(466).bytes(message.purchaseInfoData)
    }
    if (message.defaultPlaybackRate !== undefined && message.defaultPlaybackRate !== 0) {
    ...
    if (message.downloadProgress !== undefined && message.downloadProgress !== 0) {
      writer.uint32(493).float(message.downloadProgress)
    }
    if (message.appMetricsData !== undefined && message.appMetricsData.length !== 0) {
    ...
    if (message.nowPlayingInfoData !== undefined && message.nowPlayingInfoData.length !== 0) {
      writer.uint32(538).bytes(message.nowPlayingInfoData)
    }
    if (message.userInfoData !== undefined && message.userInfoData.length !== 0) {
    ...
    if (message.collectionInfoData !== undefined && message.collectionInfoData.length !== 0) {
      writer.uint32(586).bytes(message.collectionInfoData)
    }
    if (message.elapsedTimeTimestamp !== undefined && message.elapsedTimeTimestamp !== 0) {
      writer.uint32(593).double(message.elapsedTimeTimestamp)
    }
    if (message.inferredTimestamp !== undefined && message.inferredTimestamp !== 0) {
      writer.uint32(601).double(message.inferredTimestamp)
    }
    if (message.serviceIdentifier !== undefined && message.serviceIdentifier !== '') {
    ...
    if (message.artworkIdentifier !== undefined && message.artworkIdentifier !== '') {
    ...
    if (message.legacyUniqueIdentifier !== undefined && message.legacyUniqueIdentifier !== 0) {
    ...
    if (message.brandIdentifier !== undefined && message.brandIdentifier !== '') {
      writer.uint32(690).string(message.brandIdentifier)
    }
    if (message.localizedDurationString !== undefined && message.localizedDurationString !== '') {
    ...
    if (message.preferredFormat !== undefined) {
      AudioFormat.encode(message.preferredFormat, writer.uint32(738).fork()).join()
    }
    if (message.activeFormat !== undefined) {
      AudioFormat.encode(message.activeFormat, writer.uint32(746).fork()).join()
    }
    if (
    ...
    if (message.formatTierPreference !== undefined && message.formatTierPreference !== 1) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ContentItemMetadata {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input)
    const end = length === undefined ? reader.len : reader.pos + length
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 55: {
          ...
          message.iTunesStoreSubscriptionIdentifier = longToNumber(reader.int64())
          continue
        }
        case 56: {
          if (tag !== 448) {
        ...
        case 97: {
          ...
          message.alternativeFormats.push(AudioFormat.decode(reader, reader.uint32()))
          continue
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): ContentItemMetadata {
    return {
      ...
      isContainer: isSet(object.isContainer) ? globalThis.Boolean(object.isContainer) : false,
      isPlayable: isSet(object.isPlayable) ? globalThis.Boolean(object.isPlayable) : false,
      playbackProgress: isSet(object.playbackProgress)
        ? globalThis.Number(object.playbackProgress)
        : 0,
      albumName: isSet(object.albumName) ? globalThis.String(object.albumName) : '',
      ...
      albumArtistName: isSet(object.albumArtistName)
        ...
        : '',
      directorName: isSet(object.directorName) ? globalThis.String(object.directorName) : '',
      seasonNumber: isSet(object.seasonNumber) ? globalThis.Number(object.seasonNumber) : 0,
      episodeNumber: isSet(object.episodeNumber) ? globalThis.Number(object.episodeNumber) : 0,
      ...
      isExplicitItem: isSet(object.isExplicitItem)
        ...
        : false,
      playlistType: isSet(object.playlistType) ? globalThis.Number(object.playlistType) : 0,
      ...
      artworkAvailable: isSet(object.artworkAvailable)
        ...
        : false,
      infoAvailable: isSet(object.infoAvailable) ? globalThis.Boolean(object.infoAvailable) : false,
      ...
      artworkMIMEType: isSet(object.artworkMIMEType)
        ...
        : '',
      assetURLString: isSet(object.assetURLString) ? globalThis.String(object.assetURLString) : '',
      composer: isSet(object.composer) ? globalThis.String(object.composer) : '',
      discNumber: isSet(object.discNumber) ? globalThis.Number(object.discNumber) : 0,
      elapsedTime: isSet(object.elapsedTime) ? globalThis.Number(object.elapsedTime) : 0,
      genre: isSet(object.genre) ? globalThis.String(object.genre) : '',
      isAlwaysLive: isSet(object.isAlwaysLive) ? globalThis.Boolean(object.isAlwaysLive) : false,
      playbackRate: isSet(object.playbackRate) ? globalThis.Number(object.playbackRate) : 0,
      chapterCount: isSet(object.chapterCount) ? globalThis.Number(object.chapterCount) : 0,
      totalDiscCount: isSet(object.totalDiscCount) ? globalThis.Number(object.totalDiscCount) : 0,
      totalTrackCount: isSet(object.totalTrackCount)
        ? globalThis.Number(object.totalTrackCount)
        : 0,
      trackNumber: isSet(object.trackNumber) ? globalThis.Number(object.trackNumber) : 0,
      contentIdentifier: isSet(object.contentIdentifier)
        ? globalThis.String(object.contentIdentifier)
        : '',
      isSharable: isSet(object.isSharable) ? globalThis.Boolean(object.isSharable) : false,
      isLiked: isSet(object.isLiked) ? globalThis.Boolean(object.isLiked) : false,
      isInWishList: isSet(object.isInWishList) ? globalThis.Boolean(object.isInWishList) : false,
      ...
      iTunesStoreIdentifier: isSet(object.iTunesStoreIdentifier)
        ...
        : 0,
      iTunesStoreSubscriptionIdentifier: isSet(object.iTunesStoreSubscriptionIdentifier)
      ...
      defaultPlaybackRate: isSet(object.defaultPlaybackRate)
        ...
        : 0,
      downloadState: isSet(object.downloadState) ? globalThis.Number(object.downloadState) : 0,
      ...
      appMetricsData: isSet(object.appMetricsData)
        ...
        : Buffer.alloc(0),
      seriesName: isSet(object.seriesName) ? globalThis.String(object.seriesName) : '',
      ...
      userInfoData: isSet(object.userInfoData)
        ...
        : Buffer.alloc(0),
      isSteerable: isSet(object.isSteerable) ? globalThis.Boolean(object.isSteerable) : false,
      artworkURL: isSet(object.artworkURL) ? globalThis.String(object.artworkURL) : '',
      lyricsURL: isSet(object.lyricsURL) ? globalThis.String(object.lyricsURL) : '',
      ...
      artworkIdentifier: isSet(object.artworkIdentifier)
        ...
        : '',
      isLoading: isSet(object.isLoading) ? globalThis.Boolean(object.isLoading) : false,
      ...
      legacyUniqueIdentifier: isSet(object.legacyUniqueIdentifier)
        ...
        : 0,
      episodeType: isSet(object.episodeType) ? globalThis.Number(object.episodeType) : 0,
      artworkFileURL: isSet(object.artworkFileURL) ? globalThis.String(object.artworkFileURL) : '',
      ...
      localizedDurationString: isSet(object.localizedDurationString)
        ...
        : '',
      albumYear: isSet(object.albumYear) ? globalThis.String(object.albumYear) : '',
      songTraits: isSet(object.songTraits) ? songTraits_EnumFromJSON(object.songTraits) : 0,
      albumTraits: isSet(object.albumTraits) ? albumTraits_EnumFromJSON(object.albumTraits) : 0,
      ...
      activeFormatJustification: isSet(object.activeFormatJustification)
        ? activeFormatJustification_EnumFromJSON(object.activeFormatJustification)
        : 0,
      formatTierPreference: isSet(object.formatTierPreference)
        ? formatTier_EnumFromJSON(object.formatTierPreference)
        : 1,
      audioRoute: isSet(object.audioRoute) ? AudioRoute.fromJSON(object.audioRoute) : undefined,
  ...
  toJSON(message: ContentItemMetadata): unknown {
    ...
    if (
      ...
      obj.iTunesStoreSubscriptionIdentifier = Math.round(message.iTunesStoreSubscriptionIdentifier)
    }
    if (
      message.iTunesStoreArtistIdentifier !== undefined &&
      message.iTunesStoreArtistIdentifier !== 0
    ) {
      obj.iTunesStoreArtistIdentifier = Math.round(message.iTunesStoreArtistIdentifier)
    }
    if (
      message.iTunesStoreAlbumIdentifier !== undefined &&
      message.iTunesStoreAlbumIdentifier !== 0
    ) {
      obj.iTunesStoreAlbumIdentifier = Math.round(message.iTunesStoreAlbumIdentifier)
    }
    if (message.purchaseInfoData !== undefined && message.purchaseInfoData.length !== 0) {
    ...
    if (message.mediaSubType !== undefined && message.mediaSubType !== 0) {
      obj.mediaSubType = contentItemMetadata_MediaSubTypeToJSON(message.mediaSubType)
    }
    if (message.nowPlayingInfoData !== undefined && message.nowPlayingInfoData.length !== 0) {
    ...
    if (
      ...
      obj.deviceSpecificUserInfoData = base64FromBytes(message.deviceSpecificUserInfoData)
    }
    if (message.collectionInfoData !== undefined && message.collectionInfoData.length !== 0) {
    ...
    if (
      ...
      obj.currentPlaybackDateData = base64FromBytes(message.currentPlaybackDateData)
    }
    if (message.artworkIdentifier !== undefined && message.artworkIdentifier !== '') {
    ...
    if (
      ...
      obj.artworkURLTemplatesData = base64FromBytes(message.artworkURLTemplatesData)
    }
    if (message.legacyUniqueIdentifier !== undefined && message.legacyUniqueIdentifier !== 0) {
    ...
    if (message.formatTierPreference !== undefined && message.formatTierPreference !== 1) {
      obj.formatTierPreference = formatTier_EnumToJSON(message.formatTierPreference)
    }
    if (message.audioRoute !== undefined) {
      obj.audioRoute = AudioRoute.toJSON(message.audioRoute)
    }
    if (message.alternativeFormats?.length) {
      obj.alternativeFormats = message.alternativeFormats.map(e => AudioFormat.toJSON(e))
    }
    return obj
  },

  create<I extends Exact<DeepPartial<ContentItemMetadata>, I>>(base?: I): ContentItemMetadata {
  ...
  fromPartial<I extends Exact<DeepPartial<ContentItemMetadata>, I>>(
    ...
    message.iTunesStoreSubscriptionIdentifier = object.iTunesStoreSubscriptionIdentifier ?? 0
    message.iTunesStoreArtistIdentifier = object.iTunesStoreArtistIdentifier ?? 0
    ...
    message.deviceSpecificUserInfoData = object.deviceSpecificUserInfoData ?? Buffer.alloc(0)
    ...
    message.currentPlaybackDateData = object.currentPlaybackDateData ?? Buffer.alloc(0)
    message.artworkIdentifier = object.artworkIdentifier ?? ''
    message.isLoading = object.isLoading ?? false
    message.artworkURLTemplatesData = object.artworkURLTemplatesData ?? Buffer.alloc(0)
