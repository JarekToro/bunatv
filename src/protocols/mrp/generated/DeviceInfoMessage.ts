...
import { DeviceClass_Enum, deviceClass_EnumFromJSON, deviceClass_EnumToJSON } from './Common'
...
export function preferredEncoding_EnumFromJSON(object: any): PreferredEncoding_Enum {
  switch (object) {
    case 0:
    case 'Default':
...
export function preferredEncoding_EnumToJSON(object: PreferredEncoding_Enum): string {
  switch (object) {
...
export const PreferredEncoding: MessageFns<PreferredEncoding> = {
  encode(message: PreferredEncoding, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  create<I extends Exact<DeepPartial<PreferredEncoding>, I>>(base?: I): PreferredEncoding {
    return PreferredEncoding.fromPartial(base ?? ({} as any))
  },
  fromPartial<I extends Exact<DeepPartial<PreferredEncoding>, I>>(_: I): PreferredEncoding {
    const message = createBasePreferredEncoding()
    return message
  },
}
...
export const DeviceInfoMessage: MessageFns<DeviceInfoMessage> = {
  encode(message: DeviceInfoMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.localizedModelName !== undefined && message.localizedModelName !== '') {
      writer.uint32(26).string(message.localizedModelName)
    }
    if (message.systemBuildVersion !== undefined && message.systemBuildVersion !== '') {
    ...
    if (message.applicationBundleVersion !== undefined && message.applicationBundleVersion !== '') {
    ...
    if (message.lastSupportedMessageType !== undefined && message.lastSupportedMessageType !== 0) {
      writer.uint32(64).uint32(message.lastSupportedMessageType)
    }
    if (message.supportsSystemPairing !== undefined && message.supportsSystemPairing !== false) {
      writer.uint32(72).bool(message.supportsSystemPairing)
    }
    if (message.allowsPairing !== undefined && message.allowsPairing !== false) {
    ...
    if (message.systemMediaApplication !== undefined && message.systemMediaApplication !== '') {
    ...
    if (message.supportsExtendedMotion !== undefined && message.supportsExtendedMotion !== false) {
      writer.uint32(120).bool(message.supportsExtendedMotion)
    }
    if (message.bluetoothAddress !== undefined && message.bluetoothAddress.length !== 0) {
      writer.uint32(130).bytes(message.bluetoothAddress)
    }
    if (message.sharedQueueVersion !== undefined && message.sharedQueueVersion !== 0) {
    ...
    if (message.managedConfigDeviceID !== undefined && message.managedConfigDeviceID !== '') {
    ...
    if (message.logicalDeviceCount !== undefined && message.logicalDeviceCount !== 0) {
      writer.uint32(176).uint32(message.logicalDeviceCount)
    }
    if (message.tightlySyncedGroup !== undefined && message.tightlySyncedGroup !== false) {
    ...
    if (message.isAirplayActive !== undefined && message.isAirplayActive !== false) {
      writer.uint32(240).bool(message.isAirplayActive)
    }
    if (message.systemPodcastApplication !== undefined && message.systemPodcastApplication !== '') {
      writer.uint32(250).string(message.systemPodcastApplication)
    }
    if (message.senderDefaultGroupUID !== undefined && message.senderDefaultGroupUID !== '') {
    ...
    if (message.clusterLeaderID !== undefined && message.clusterLeaderID !== '') {
    ...
    if (message.isClusterAware !== undefined && message.isClusterAware !== false) {
    ...
    if (message.supportsMultiplayer !== undefined && message.supportsMultiplayer !== false) {
      writer.uint32(320).bool(message.supportsMultiplayer)
    }
    if (message.routingContextID !== undefined && message.routingContextID !== '') {
    ...
    if (message.systemBooksApplication !== undefined && message.systemBooksApplication !== '') {
    ...
    if (
      ...
      writer.uint32(360).uint32(message.parentGroupContainsDiscoverableGroupLeader)
    }
    if (
    ...
    if (message.lastKnownClusterType !== undefined && message.lastKnownClusterType !== 0) {
    ...
    if (message.preferredEncoding !== undefined && message.preferredEncoding !== 0) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 28: {
          ...
          message.groupedDevices.push(DeviceInfoMessage.decode(reader, reader.uint32()))
          continue
        }
        case 29: {
          if (tag !== 232) {
        ...
        case 44: {
          ...
          message.clusteredDevices.push(DeviceInfoMessage.decode(reader, reader.uint32()))
          continue
        }
        case 45: {
          if (tag !== 360) {
  ...
  fromJSON(object: any): DeviceInfoMessage {
    return {
      ...
      supportsSystemPairing: isSet(object.supportsSystemPairing)
        ...
        : false,
      allowsPairing: isSet(object.allowsPairing) ? globalThis.Boolean(object.allowsPairing) : false,
      ...
      systemMediaApplication: isSet(object.systemMediaApplication)
        ...
        : '',
      supportsACL: isSet(object.supportsACL) ? globalThis.Boolean(object.supportsACL) : false,
      ...
      sharedQueueVersion: isSet(object.sharedQueueVersion)
        ...
        : 0,
      deviceUID: isSet(object.deviceUID) ? globalThis.String(object.deviceUID) : '',
      managedConfigDeviceID: isSet(object.managedConfigDeviceID)
        ? globalThis.String(object.managedConfigDeviceID)
        : '',
      deviceClass: isSet(object.deviceClass) ? deviceClass_EnumFromJSON(object.deviceClass) : 0,
      ...
      isProxyGroupPlayer: isSet(object.isProxyGroupPlayer)
        ...
        : false,
      tightSyncUID: isSet(object.tightSyncUID) ? globalThis.String(object.tightSyncUID) : '',
      groupUID: isSet(object.groupUID) ? globalThis.String(object.groupUID) : '',
      ...
      airplayReceivers: globalThis.Array.isArray(object?.airplayReceivers)
        ...
        : [],
      linkAgent: isSet(object.linkAgent) ? globalThis.String(object.linkAgent) : '',
      ...
      parentGroupContainsDiscoverableGroupLeader: isSet(
        ...
        : 0,
      groupContainsDiscoverableGroupLeader: isSet(object.groupContainsDiscoverableGroupLeader)
  ...
  toJSON(message: DeviceInfoMessage): unknown {
    ...
    if (message.lastSupportedMessageType !== undefined && message.lastSupportedMessageType !== 0) {
      obj.lastSupportedMessageType = Math.round(message.lastSupportedMessageType)
    }
    if (message.supportsSystemPairing !== undefined && message.supportsSystemPairing !== false) {
    ...
    if (message.groupedDevices?.length) {
      obj.groupedDevices = message.groupedDevices.map(e => DeviceInfoMessage.toJSON(e))
    }
    if (message.isGroupLeader !== undefined && message.isGroupLeader !== false) {
    ...
    if (message.clusteredDevices?.length) {
      obj.clusteredDevices = message.clusteredDevices.map(e => DeviceInfoMessage.toJSON(e))
    }
    if (
      message.parentGroupContainsDiscoverableGroupLeader !== undefined &&
      message.parentGroupContainsDiscoverableGroupLeader !== 0
    ...
    if (message.preferredEncoding !== undefined && message.preferredEncoding !== 0) {
      obj.preferredEncoding = preferredEncoding_EnumToJSON(message.preferredEncoding)
    }
    return obj
  },

  create<I extends Exact<DeepPartial<DeviceInfoMessage>, I>>(base?: I): DeviceInfoMessage {
    return DeviceInfoMessage.fromPartial(base ?? ({} as any))
  },
  fromPartial<I extends Exact<DeepPartial<DeviceInfoMessage>, I>>(object: I): DeviceInfoMessage {
    const message = createBaseDeviceInfoMessage()
    ...
    message.applicationBundleIdentifier = object.applicationBundleIdentifier ?? ''
    ...
    message.groupedDevices = object.groupedDevices?.map(e => DeviceInfoMessage.fromPartial(e)) || []
    ...
    message.groupContainsDiscoverableGroupLeader = object.groupContainsDiscoverableGroupLeader ?? 0
    message.lastKnownClusterType = object.lastKnownClusterType ?? 0
    message.supportsOutputContextSync = object.supportsOutputContextSync ?? false
