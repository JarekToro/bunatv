...
//   protoc               unknown
// source: messages/playback/PlaybackQueueRequestMessage.proto

/* eslint-disable */
import { BinaryReader, BinaryWriter } from "@bufbuild/protobuf/wire";
import { PlaybackQueueContext } from "../../types/playback/PlaybackQueueContext";
...
export interface PlaybackQueueRequestMessage {
  ...
  includeAvailableArtworkFormats?: boolean | undefined;
  requestedArtworkFormats: string[];
  requestedRemoteArtworkFormats: string[];
  includeAlignments?: boolean | undefined;
...
export const PlaybackQueueRequestMessage: MessageFns<PlaybackQueueRequestMessage> =
  {
    encode(
      ...
      for (const v of message.requestedAnimatedArtworkAssetUrlFormats) {
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 10: {
            ...
            message.context = PlaybackQueueContext.decode(
              reader,
              reader.uint32()
            );
            continue;
          ...
          case 18: {
            ...
            message.includeParticipants = reader.bool();
            continue;
          }
          case 19: {
            if (tag !== 152) {
            ...
            message.includeAvailableArtworkFormats = reader.bool();
            continue;
          }
          case 20: {
            if (tag !== 162) {
            ...
            message.requestedArtworkFormats.push(reader.string());
            continue;
          }
          case 21: {
            if (tag !== 170) {
            ...
            message.requestedRemoteArtworkFormats.push(reader.string());
            continue;
          }
          case 22: {
            if (tag !== 176) {
            ...
            message.includeAlignments = reader.bool();
            continue;
          }
          case 23: {
            if (tag !== 186) {
            ...
            message.requestedAnimatedArtworkPreviewFrameFormats.push(
              reader.string()
            );
            continue;
          }
          case 24: {
            ...
            message.requestedAnimatedArtworkAssetUrlFormats.push(
              reader.string()
            );
            continue;
          }
    ...
    fromJSON(object: any): PlaybackQueueRequestMessage {
      return {
        ...
        contentItemIdentifiers: globalThis.Array.isArray(
          ...
          : [],
        returnContentItemAssetsInUserCompletion: isSet(
        ...
        requestedArtworkFormats: globalThis.Array.isArray(
          ...
          ? object.requestedArtworkFormats.map((e: any) => globalThis.String(e))
          : [],
        requestedRemoteArtworkFormats: globalThis.Array.isArray(
          object?.requestedRemoteArtworkFormats
        )
          ? object.requestedRemoteArtworkFormats.map((e: any) =>
              globalThis.String(e)
            )
          : [],
        ...
        requestedAnimatedArtworkPreviewFrameFormats: globalThis.Array.isArray(
          ...
          ? object.requestedAnimatedArtworkPreviewFrameFormats.map((e: any) =>
              globalThis.String(e)
            )
          : [],
        requestedAnimatedArtworkAssetUrlFormats: globalThis.Array.isArray(
          object?.requestedAnimatedArtworkAssetUrlFormats
        )
          ? object.requestedAnimatedArtworkAssetUrlFormats.map((e: any) =>
              globalThis.String(e)
            )
          : [],
      };
    ...
    toJSON(message: PlaybackQueueRequestMessage): unknown {
      ...
      if (message.requestedArtworkFormats?.length) {
        obj.requestedArtworkFormats = message.requestedArtworkFormats;
      }
      if (message.requestedRemoteArtworkFormats?.length) {
      ...
      if (message.requestedAnimatedArtworkPreviewFrameFormats?.length) {
        obj.requestedAnimatedArtworkPreviewFrameFormats =
          message.requestedAnimatedArtworkPreviewFrameFormats;
      }
      if (message.requestedAnimatedArtworkAssetUrlFormats?.length) {
        obj.requestedAnimatedArtworkAssetUrlFormats =
    ...
    fromPartial<I extends Exact<DeepPartial<PlaybackQueueRequestMessage>, I>>(
      ...
      message.requestedAnimatedArtworkAssetUrlFormats =
        object.requestedAnimatedArtworkAssetUrlFormats?.map((e) => e) || [];
      return message;
    },
  };

export const playbackQueueRequestMessage: Extension<
  PlaybackQueueRequestMessage | undefined
> = {
  number: 37,
  tag: 298,
  repeated: false,
