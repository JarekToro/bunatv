...
//   protoc               unknown
// source: messages/device/CreateHostedEndpointResponseMessage.proto
...
/** Response after creating a hosted endpoint */
export interface CreateHostedEndpointResponseMessage {
...
export const CreateHostedEndpointResponseMessage: MessageFns<CreateHostedEndpointResponseMessage> =
  {
    ...
    fromJSON(object: any): CreateHostedEndpointResponseMessage {
      return {
    ...
    >(base?: I): CreateHostedEndpointResponseMessage {
      return CreateHostedEndpointResponseMessage.fromPartial(
        base ?? ({} as any)
      );
    },
    fromPartial<
...
export const createHostedEndpointResponseMessage: Extension<
  CreateHostedEndpointResponseMessage | undefined
> = {
  number: 96,
  tag: 770,
  repeated: false,
  packed: false,
  encode: (
    value: CreateHostedEndpointResponseMessage | undefined
  ): Uint8Array[] => {
    ...
    CreateHostedEndpointResponseMessage.encode(value, writer.fork()).join();
  ...
  decode: (
    ...
    return CreateHostedEndpointResponseMessage.decode(reader, reader.uint32());
  },
};
