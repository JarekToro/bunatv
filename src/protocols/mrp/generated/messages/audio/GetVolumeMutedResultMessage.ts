...
//   protoc               unknown
// source: messages/audio/GetVolumeMutedResultMessage.proto
...
/** Response with muted state of an output device */
export interface GetVolumeMutedResultMessage {
...
export const GetVolumeMutedResultMessage: MessageFns<GetVolumeMutedResultMessage> =
  {
    ...
    fromJSON(object: any): GetVolumeMutedResultMessage {
      return {
    ...
    create<I extends Exact<DeepPartial<GetVolumeMutedResultMessage>, I>>(
      base?: I
    ): GetVolumeMutedResultMessage {
      return GetVolumeMutedResultMessage.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<GetVolumeMutedResultMessage>, I>>(
      object: I
    ): GetVolumeMutedResultMessage {
      const message = createBaseGetVolumeMutedResultMessage();
...
export const getVolumeMutedResultMessage: Extension<
  GetVolumeMutedResultMessage | undefined
> = {
  number: 99,
  tag: 794,
  repeated: false,
  packed: false,
  encode: (value: GetVolumeMutedResultMessage | undefined): Uint8Array[] => {
    const encoded: Uint8Array[] = [];
    if (value === undefined) {
      return encoded;
    }
    const writer = new BinaryWriter();
    GetVolumeMutedResultMessage.encode(value, writer.fork()).join();
  ...
  decode: (
    ...
    return GetVolumeMutedResultMessage.decode(reader, reader.uint32());
  },
};
