...
export const RegisterHIDDeviceResultMessage: MessageFns<RegisterHIDDeviceResultMessage> = {
  encode(
    ...
    if (message.deviceIdentifier !== undefined && message.deviceIdentifier !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RegisterHIDDeviceResultMessage {
  ...
  fromPartial<I extends Exact<DeepPartial<RegisterHIDDeviceResultMessage>, I>>(
    object: I
  ): RegisterHIDDeviceResultMessage {
    const message = createBaseRegisterHIDDeviceResultMessage()
...
export const registerHIDDeviceResultMessage: Extension<RegisterHIDDeviceResultMessage | undefined> =
  {
    number: 12,
    tag: 98,
    repeated: false,
    ...
    decode: (tag: number, input: Uint8Array[]): RegisterHIDDeviceResultMessage | undefined => {
