...
export const SetDefaultSupportedCommandsMessage: MessageFns<SetDefaultSupportedCommandsMessage> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SetDefaultSupportedCommandsMessage {
  ...
  create<I extends Exact<DeepPartial<SetDefaultSupportedCommandsMessage>, I>>(
    ...
    return SetDefaultSupportedCommandsMessage.fromPartial(base ?? ({} as any))
  },
  fromPartial<I extends Exact<DeepPartial<SetDefaultSupportedCommandsMessage>, I>>(
    object: I
  ): SetDefaultSupportedCommandsMessage {
    const message = createBaseSetDefaultSupportedCommandsMessage()
...
> = {
  ...
  repeated: false,
  packed: false,
  encode: (value: SetDefaultSupportedCommandsMessage | undefined): Uint8Array[] => {
  ...
  decode: (tag: number, input: Uint8Array[]): SetDefaultSupportedCommandsMessage | undefined => {
