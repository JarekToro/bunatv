...
export const CommandOptions: MessageFns<CommandOptions> = {
  encode(message: CommandOptions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.externalPlayerCommand !== undefined && message.externalPlayerCommand !== false) {
    ...
    if (message.playbackPosition !== undefined && message.playbackPosition !== 0) {
    ...
    if (message.radioStationHash !== undefined && message.radioStationHash !== '') {
    ...
    if (message.destinationAppDisplayID !== undefined && message.destinationAppDisplayID !== '') {
    ...
    if (message.playbackQueueOffset !== undefined && message.playbackQueueOffset !== 0) {
    ...
    if (message.languageOption !== undefined && message.languageOption.length !== 0) {
      writer.uint32(218).bytes(message.languageOption)
    }
    if (message.playbackQueueContext !== undefined && message.playbackQueueContext.length !== 0) {
      writer.uint32(226).bytes(message.playbackQueueContext)
    }
    if (message.insertAfterContentItemID !== undefined && message.insertAfterContentItemID !== '') {
      writer.uint32(234).string(message.insertAfterContentItemID)
    }
    if (message.nowPlayingContentItemID !== undefined && message.nowPlayingContentItemID !== '') {
  ...
  fromJSON(object: any): CommandOptions {
    return {
      ...
      radioStationID: isSet(object.radioStationID) ? globalThis.Number(object.radioStationID) : 0,
      ...
      destinationAppDisplayID: isSet(object.destinationAppDisplayID)
        ...
        : '',
      sendOptions: isSet(object.sendOptions) ? globalThis.Number(object.sendOptions) : 0,
      requestDefermentToPlaybackQueuePosition: isSet(object.requestDefermentToPlaybackQueuePosition)
      ...
      shouldOverrideManuallyCuratedQueue: isSet(object.shouldOverrideManuallyCuratedQueue)
        ? globalThis.Boolean(object.shouldOverrideManuallyCuratedQueue)
        : false,
      stationURL: isSet(object.stationURL) ? globalThis.String(object.stationURL) : '',
      shouldBeginRadioPlayback: isSet(object.shouldBeginRadioPlayback)
        ? globalThis.Boolean(object.shouldBeginRadioPlayback)
        : false,
      playbackQueueInsertionPosition: isSet(object.playbackQueueInsertionPosition)
        ? globalThis.Number(object.playbackQueueInsertionPosition)
        : 0,
      contentItemID: isSet(object.contentItemID) ? globalThis.String(object.contentItemID) : '',
      playbackQueueOffset: isSet(object.playbackQueueOffset)
        ? globalThis.Number(object.playbackQueueOffset)
        : 0,
      playbackQueueDestinationOffset: isSet(object.playbackQueueDestinationOffset)
      ...
      nowPlayingContentItemID: isSet(object.nowPlayingContentItemID)
        ...
        : '',
      replaceIntent: isSet(object.replaceIntent) ? globalThis.Number(object.replaceIntent) : 0,
    }
  },
  ...
  toJSON(message: CommandOptions): unknown {
    ...
    if (
      ...
      obj.systemAppPlaybackQueueData = base64FromBytes(message.systemAppPlaybackQueueData)
    }
    if (message.destinationAppDisplayID !== undefined && message.destinationAppDisplayID !== '') {
    ...
    if (
      ...
      obj.requestDefermentToPlaybackQueuePosition = message.requestDefermentToPlaybackQueuePosition
    }
    if (message.contextID !== undefined && message.contextID !== '') {
    ...
    if (
      ...
      obj.shouldOverrideManuallyCuratedQueue = message.shouldOverrideManuallyCuratedQueue
    }
    if (message.stationURL !== undefined && message.stationURL !== '') {
    ...
    if (
      ...
      obj.playbackQueueInsertionPosition = Math.round(message.playbackQueueInsertionPosition)
    }
    if (message.contentItemID !== undefined && message.contentItemID !== '') {
    ...
    if (
      ...
      obj.playbackQueueDestinationOffset = Math.round(message.playbackQueueDestinationOffset)
    }
    if (message.languageOption !== undefined && message.languageOption.length !== 0) {
  ...
  create<I extends Exact<DeepPartial<CommandOptions>, I>>(base?: I): CommandOptions {
    return CommandOptions.fromPartial(base ?? ({} as any))
  },
  fromPartial<I extends Exact<DeepPartial<CommandOptions>, I>>(object: I): CommandOptions {
    const message = createBaseCommandOptions()
    ...
    message.systemAppPlaybackQueueData = object.systemAppPlaybackQueueData ?? Buffer.alloc(0)
    ...
    message.shouldOverrideManuallyCuratedQueue = object.shouldOverrideManuallyCuratedQueue ?? false
    message.stationURL = object.stationURL ?? ''
    message.shouldBeginRadioPlayback = object.shouldBeginRadioPlayback ?? false
    message.playbackQueueInsertionPosition = object.playbackQueueInsertionPosition ?? 0
    message.contentItemID = object.contentItemID ?? ''
    message.playbackQueueOffset = object.playbackQueueOffset ?? 0
    message.playbackQueueDestinationOffset = object.playbackQueueDestinationOffset ?? 0
    message.languageOption = object.languageOption ?? Buffer.alloc(0)
    message.playbackQueueContext = object.playbackQueueContext ?? Buffer.alloc(0)
