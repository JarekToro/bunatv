...
//   protoc               unknown
// source: protocol/ProtocolMessage.proto
...
export enum ProtocolMessage_Type {
  ...
  /** CONTENT_ITEMS_CHANGED_NOTIFICATION_MESSAGE - Seems deprecated */
  ...
  /** REMOVE_FROM_PARENT_GROUP_MESSAGE - Yes Same as 66 */
...
export function protocolMessage_TypeFromJSON(
  ...
  switch (object) {
    ...
    case 69:
    case "REMOVE_FROM_PARENT_GROUP_MESSAGE":
      return ProtocolMessage_Type.REMOVE_FROM_PARENT_GROUP_MESSAGE;
    case 70:
    ...
    case 78:
    case "PLAYBACK_SESSION_MIGRATE_POST_MESSAGE":
      return ProtocolMessage_Type.PLAYBACK_SESSION_MIGRATE_POST_MESSAGE;
    case 108:
    case "DISCOVERY_UPDATE_ENDPOINTS_MESSAGE":
      return ProtocolMessage_Type.DISCOVERY_UPDATE_ENDPOINTS_MESSAGE;
    case 109:
    case "DISCOVERY_UPDATE_OUTPUT_DEVICES_MESSAGE":
      return ProtocolMessage_Type.DISCOVERY_UPDATE_OUTPUT_DEVICES_MESSAGE;
    case 110:
    case "SET_LISTENING_MODE_MESSAGE":
      return ProtocolMessage_Type.SET_LISTENING_MODE_MESSAGE;
    case 121:
    case "CREATE_HOSTED_ENDPOINT_REQUEST_MESSAGE":
      return ProtocolMessage_Type.CREATE_HOSTED_ENDPOINT_REQUEST_MESSAGE;
    case 122:
    case "CREATE_HOSTED_ENDPOINT_RESPONSE_MESSAGE":
      return ProtocolMessage_Type.CREATE_HOSTED_ENDPOINT_RESPONSE_MESSAGE;
    case 125:
    case "ADJUST_VOLUME_MESSAGE":
      return ProtocolMessage_Type.ADJUST_VOLUME_MESSAGE;
    case 126:
    case "GET_VOLUME_MUTED_MESSAGE":
      return ProtocolMessage_Type.GET_VOLUME_MUTED_MESSAGE;
    case 127:
    case "GET_VOLUME_MUTED_RESULT_MESSAGE":
      return ProtocolMessage_Type.GET_VOLUME_MUTED_RESULT_MESSAGE;
    case 128:
    case "SET_VOLUME_MUTED_MESSAGE":
      return ProtocolMessage_Type.SET_VOLUME_MUTED_MESSAGE;
    case 129:
    case "VOLUME_MUTED_DID_CHANGE_MESSAGE":
      return ProtocolMessage_Type.VOLUME_MUTED_DID_CHANGE_MESSAGE;
    case 130:
    case "SET_CONVERSATION_DETECTION_ENABLED_MESSAGE":
      return ProtocolMessage_Type.SET_CONVERSATION_DETECTION_ENABLED_MESSAGE;
    case 131:
    case "PLAYER_CLIENT_PARTICIPANTS_UPDATE_MESSAGE":
      return ProtocolMessage_Type.PLAYER_CLIENT_PARTICIPANTS_UPDATE_MESSAGE;
    case 132:
    case "REQUEST_GROUP_SESSION_MESSAGE":
      return ProtocolMessage_Type.REQUEST_GROUP_SESSION_MESSAGE;
    case 133:
    case "CONFIGURE_CONNECTION_SERVICE_MESSAGE":
      return ProtocolMessage_Type.CONFIGURE_CONNECTION_SERVICE_MESSAGE;
    case 134:
    case "CREATE_APPLICATION_CONNECTION_MESSAGE":
      return ProtocolMessage_Type.CREATE_APPLICATION_CONNECTION_MESSAGE;
    case 135:
    case "APPLICATION_CONNECTION_PROTOCOL_MESSAGE":
      return ProtocolMessage_Type.APPLICATION_CONNECTION_PROTOCOL_MESSAGE;
    case 136:
    case "INVALIDATE_APPLICATION_CONNECTION_MESSAGE":
      return ProtocolMessage_Type.INVALIDATE_APPLICATION_CONNECTION_MESSAGE;
    case 137:
    case "MICROPHONE_CONNECTION_REQUEST_MESSAGE":
      return ProtocolMessage_Type.MICROPHONE_CONNECTION_REQUEST_MESSAGE;
    case 138:
    case "MICROPHONE_CONNECTION_RESPONSE_MESSAGE":
      return ProtocolMessage_Type.MICROPHONE_CONNECTION_RESPONSE_MESSAGE;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function protocolMessage_TypeToJSON(
  ...
  switch (object) {
    ...
    case ProtocolMessage_Type.REMOVE_FROM_PARENT_GROUP_MESSAGE:
      return "REMOVE_FROM_PARENT_GROUP_MESSAGE";
    ...
    case ProtocolMessage_Type.PLAYBACK_SESSION_MIGRATE_POST_MESSAGE:
      return "PLAYBACK_SESSION_MIGRATE_POST_MESSAGE";
    case ProtocolMessage_Type.DISCOVERY_UPDATE_ENDPOINTS_MESSAGE:
      return "DISCOVERY_UPDATE_ENDPOINTS_MESSAGE";
    case ProtocolMessage_Type.DISCOVERY_UPDATE_OUTPUT_DEVICES_MESSAGE:
      return "DISCOVERY_UPDATE_OUTPUT_DEVICES_MESSAGE";
    case ProtocolMessage_Type.SET_LISTENING_MODE_MESSAGE:
      return "SET_LISTENING_MODE_MESSAGE";
    case ProtocolMessage_Type.CREATE_HOSTED_ENDPOINT_REQUEST_MESSAGE:
      return "CREATE_HOSTED_ENDPOINT_REQUEST_MESSAGE";
    case ProtocolMessage_Type.CREATE_HOSTED_ENDPOINT_RESPONSE_MESSAGE:
      return "CREATE_HOSTED_ENDPOINT_RESPONSE_MESSAGE";
    case ProtocolMessage_Type.ADJUST_VOLUME_MESSAGE:
      return "ADJUST_VOLUME_MESSAGE";
    case ProtocolMessage_Type.GET_VOLUME_MUTED_MESSAGE:
      return "GET_VOLUME_MUTED_MESSAGE";
    case ProtocolMessage_Type.GET_VOLUME_MUTED_RESULT_MESSAGE:
      return "GET_VOLUME_MUTED_RESULT_MESSAGE";
    case ProtocolMessage_Type.SET_VOLUME_MUTED_MESSAGE:
      return "SET_VOLUME_MUTED_MESSAGE";
    case ProtocolMessage_Type.VOLUME_MUTED_DID_CHANGE_MESSAGE:
      return "VOLUME_MUTED_DID_CHANGE_MESSAGE";
    case ProtocolMessage_Type.SET_CONVERSATION_DETECTION_ENABLED_MESSAGE:
      return "SET_CONVERSATION_DETECTION_ENABLED_MESSAGE";
    case ProtocolMessage_Type.PLAYER_CLIENT_PARTICIPANTS_UPDATE_MESSAGE:
      return "PLAYER_CLIENT_PARTICIPANTS_UPDATE_MESSAGE";
    case ProtocolMessage_Type.REQUEST_GROUP_SESSION_MESSAGE:
      return "REQUEST_GROUP_SESSION_MESSAGE";
    case ProtocolMessage_Type.CONFIGURE_CONNECTION_SERVICE_MESSAGE:
      return "CONFIGURE_CONNECTION_SERVICE_MESSAGE";
    case ProtocolMessage_Type.CREATE_APPLICATION_CONNECTION_MESSAGE:
      return "CREATE_APPLICATION_CONNECTION_MESSAGE";
    case ProtocolMessage_Type.APPLICATION_CONNECTION_PROTOCOL_MESSAGE:
      return "APPLICATION_CONNECTION_PROTOCOL_MESSAGE";
    case ProtocolMessage_Type.INVALIDATE_APPLICATION_CONNECTION_MESSAGE:
      return "INVALIDATE_APPLICATION_CONNECTION_MESSAGE";
    case ProtocolMessage_Type.MICROPHONE_CONNECTION_REQUEST_MESSAGE:
      return "MICROPHONE_CONNECTION_REQUEST_MESSAGE";
    case ProtocolMessage_Type.MICROPHONE_CONNECTION_RESPONSE_MESSAGE:
      return "MICROPHONE_CONNECTION_RESPONSE_MESSAGE";
