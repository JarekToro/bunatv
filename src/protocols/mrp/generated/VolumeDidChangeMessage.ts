...
function createBaseVolumeDidChangeMessage(): VolumeDidChangeMessage {
  return { volume: 0, endpointUID: '', outputDeviceUID: '', _unknownFields: {} }
}

export const VolumeDidChangeMessage: MessageFns<VolumeDidChangeMessage> = {
  encode(message: VolumeDidChangeMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): VolumeDidChangeMessage {
...
export const volumeDidChangeMessage: Extension<VolumeDidChangeMessage | undefined> = {
  number: 56,
  tag: 450,
  repeated: false,
  packed: false,
  ...
  decode: (tag: number, input: Uint8Array[]): VolumeDidChangeMessage | undefined => {
