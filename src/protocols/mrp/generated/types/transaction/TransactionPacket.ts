...
//   protoc               unknown
// source: types/transaction/TransactionPacket.proto
...
export const TransactionPacket: MessageFns<TransactionPacket> = {
  ...
  create<I extends Exact<DeepPartial<TransactionPacket>, I>>(
    base?: I
  ): TransactionPacket {
    return TransactionPacket.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<TransactionPacket>, I>>(
    object: I
  ): TransactionPacket {
    const message = createBaseTransactionPacket();
    message.key =
