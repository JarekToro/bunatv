...
//   protoc               unknown
// source: types/playback/PlaybackQueue.proto
...
import { PlaybackQueueParticipant } from "./PlaybackQueueParticipant";
...
export interface PlaybackQueue {
  ...
  properties?: Dictionary | undefined;
  auxiliaryNowPlayingInfo?: Dictionary | undefined;
...
function createBasePlaybackQueue(): PlaybackQueue {
  return {
    ...
    auxiliaryNowPlayingInfo: undefined,
    _unknownFields: {},
  };
}
...
export const PlaybackQueue: MessageFns<PlaybackQueue> = {
  encode(
    ...
    for (const v of message.participants) {
      PlaybackQueueParticipant.encode(v!, writer.uint32(66).fork()).join();
    }
    for (const v of message.homeUserIdentifiers) {
      writer.uint32(74).string(v!);
    }
    if (message.properties !== undefined) {
      Dictionary.encode(message.properties, writer.uint32(82).fork()).join();
    }
    if (message.auxiliaryNowPlayingInfo !== undefined) {
      Dictionary.encode(
        message.auxiliaryNowPlayingInfo,
      ...
      switch (tag >>> 3) {
        ...
        case 8: {
          ...
          message.participants.push(
            PlaybackQueueParticipant.decode(reader, reader.uint32())
          );
          continue;
        }
        case 9: {
          ...
          message.homeUserIdentifiers.push(reader.string());
          continue;
        }
        case 10: {
          if (tag !== 82) {
          ...
          message.properties = Dictionary.decode(reader, reader.uint32());
          continue;
        }
        case 11: {
          if (tag !== 90) {
          ...
          message.auxiliaryNowPlayingInfo = Dictionary.decode(
            reader,
            reader.uint32()
          );
          continue;
  ...
  fromJSON(object: any): PlaybackQueue {
    return {
      ...
      resolvedPlayerPath: isSet(object.resolvedPlayerPath)
        ...
        : undefined,
      sendingPlaybackQueueTransaction: isSet(
      ...
      participants: globalThis.Array.isArray(object?.participants)
        ...
        : [],
      homeUserIdentifiers: globalThis.Array.isArray(object?.homeUserIdentifiers)
        ? object.homeUserIdentifiers.map((e: any) => globalThis.String(e))
        : [],
      properties: isSet(object.properties)
        ? Dictionary.fromJSON(object.properties)
        : undefined,
      auxiliaryNowPlayingInfo: isSet(object.auxiliaryNowPlayingInfo)
        ? Dictionary.fromJSON(object.auxiliaryNowPlayingInfo)
        : undefined,
    };
  },
  ...
  toJSON(message: PlaybackQueue): unknown {
    ...
    if (message.participants?.length) {
      obj.participants = message.participants.map((e) =>
        PlaybackQueueParticipant.toJSON(e)
      );
    }
    if (message.homeUserIdentifiers?.length) {
      obj.homeUserIdentifiers = message.homeUserIdentifiers;
    }
    if (message.properties !== undefined) {
      obj.properties = Dictionary.toJSON(message.properties);
    }
    if (message.auxiliaryNowPlayingInfo !== undefined) {
      obj.auxiliaryNowPlayingInfo = Dictionary.toJSON(
        message.auxiliaryNowPlayingInfo
      );
    }
    return obj;
  ...
  create<I extends Exact<DeepPartial<PlaybackQueue>, I>>(
    base?: I
  ): PlaybackQueue {
    return PlaybackQueue.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<PlaybackQueue>, I>>(
    object: I
  ): PlaybackQueue {
    const message = createBasePlaybackQueue();
    ...
    message.homeUserIdentifiers =
      object.homeUserIdentifiers?.map((e) => e) || [];
    message.properties =
      object.properties !== undefined && object.properties !== null
        ? Dictionary.fromPartial(object.properties)
        : undefined;
    message.auxiliaryNowPlayingInfo =
      object.auxiliaryNowPlayingInfo !== undefined &&
      object.auxiliaryNowPlayingInfo !== null
        ? Dictionary.fromPartial(object.auxiliaryNowPlayingInfo)
        : undefined;
    return message;
  },
};
