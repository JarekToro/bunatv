...
export const UpdateContentItemMessage: MessageFns<UpdateContentItemMessage> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UpdateContentItemMessage {
...
export const updateContentItemMessage: Extension<UpdateContentItemMessage | undefined> = {
  number: 60,
  tag: 482,
  repeated: false,
  packed: false,
  ...
  decode: (tag: number, input: Uint8Array[]): UpdateContentItemMessage | undefined => {
