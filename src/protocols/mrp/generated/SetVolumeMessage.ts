...
function createBaseSetVolumeMessage(): SetVolumeMessage {
  return { volume: 0, outputDeviceUID: '', _unknownFields: {} }
}

export const SetVolumeMessage: MessageFns<SetVolumeMessage> = {
  encode(message: SetVolumeMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  create<I extends Exact<DeepPartial<SetVolumeMessage>, I>>(base?: I): SetVolumeMessage {
    return SetVolumeMessage.fromPartial(base ?? ({} as any))
  },
  fromPartial<I extends Exact<DeepPartial<SetVolumeMessage>, I>>(object: I): SetVolumeMessage {
    const message = createBaseSetVolumeMessage()
