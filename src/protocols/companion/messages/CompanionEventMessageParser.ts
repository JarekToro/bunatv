...
const processors = {
  _iMC: (message: CompanionOpackMessage) =>
    parseMediaControlEvent(message as MediaControlEvent),
  ...
  _hidT: (message: CompanionOpackMessage) =>
    parseHidTouchEvent(message as HidTouchEvent),
} as const;
