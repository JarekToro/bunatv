...
describe("Binary Serializer", () => {
  ...
  describe("ArrayBuffer Support", () => {
    it("should serialize and deserialize ArrayBuffer", () => {
      ...
      expect(Array.from(new Uint8Array(deserialized))).toEqual([
        1, 2, 3, 4, 5, 6, 7, 8,
      ]);
    });
  });
  ...
  describe("Typed Array Support", () => {
    ...
    it("should handle Int32Array", () => {
      ...
      expect(Array.from(deserialized)).toEqual([
  ...
  describe("Complex Object Support", () => {
    it("should handle objects with mixed binary and regular fields", () => {
      ...
      expect(
        Array.from(new Uint8Array(deserialized.nested.arrayBuffer))
      ).toEqual([10, 20, 30, 40]);
    });
  ...
  describe("HAP Credentials Structure", () => {
    it("should handle HAP credentials with crypto keys", () => {
      ...
      expect(Array.from(deserialized.publicKey)).toEqual(
      ...
      expect(Array.from(deserialized.privateKey)).toEqual(
      ...
      expect(Array.from(deserialized.accessoryPublicKey)).toEqual(
