...
export class ProtocolManager {
   ...
   */
  async createProtocol(device: DiscoveredDevice, storage: Storage): Promise<CompanionProtocol> {
    try {
   ...
   */
  async connect(protocol: CompanionProtocol, options?: ConnectionOptions): Promise<void> {
    try {
   ...
   */
  async disconnect(protocol: CompanionProtocol, reason: string = 'User requested'): Promise<void> {
    try {
